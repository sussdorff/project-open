...
SELECT acs_log__debug('/packages/intranet-timesheet2/sql/postgresql/upgrade/upgrade-4.0.3.3.8-4.0.3.3.9.sql','');

drop function if exists im_absences_month_absence_duration_type (integer, integer, integer, integer);
create function im_absences_month_absence_duration_type (user_id integer, month integer, year integer, absence_type_id integer)
