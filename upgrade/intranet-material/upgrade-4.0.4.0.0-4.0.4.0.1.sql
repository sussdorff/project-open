...
'"<a href=/intranet-material/new?form_mode=display&[export_vars -url {material_id return_url}]>$material_nr</a>"',
'','',0,'');

insert into im_view_columns (column_id, view_id, group_id, column_name, column_render_tcl,
extra_select, extra_where, sort_order, visible_for) values (90002,900,NULL,'Name',
'"<a href=/intranet-material/new?form_mode=display&[export_vars -url {material_id return_url}]>$material_name</a>"',
'','',2,'');
