...
RUN wget --quiet https://sourceforge.net/projects/project-open/files/project-open/V5.0/update/project-open-Update-5.0.2.4.0.tgz \
    && tar xzf project-open-Update-5.0.2.4.0.tgz && rm project-open-Update-5.0.2.4.0.tgz \
...
RUN mv -n packages/* /var/www/openacs/packages/ && rm -rf /var/www/projop
